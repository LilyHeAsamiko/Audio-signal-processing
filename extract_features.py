...
nb_mel_bands = 128  # Number of Mel-bands to calculate Mel band energy feature in
nb_frames = 320  # Extracts max_nb_frames frames of features from the audio, and ignores the rest.
...
speech_audio_folder = 'speech_wav'
music_audio_folder = 'music_wav'
